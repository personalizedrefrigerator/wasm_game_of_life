...
export class Color4 {
    ...
    static __wrap(ptr) {
        const obj = Object.create(Color4.prototype);
        obj.ptr = ptr;
    ...
    */
    static new(r, g, b, a) {
        var ret = wasm.color4_new(r, g, b, a);
        return Color4.__wrap(ret);
    }
}
/**
*/
export class Universe {
    ...
    */
    render_cells(cell_type, color, ctx) {
        try {
            _assertClass(color, Color4);
            wasm.universe_render_cells(this.ptr, cell_type, color.ptr, addBorrowedObject(ctx));
        } finally {
    ...
    */
    set_square_spacing(spacing) {
        wasm.universe_set_square_spacing(this.ptr, spacing);
    }
    /**
    * @returns {number}
    */
...
async function init(input) {
    ...
    imports.wbg.__wbg_newwithu8clampedarray_1b77d3dfdbcc7508 = function() { return handleError(function (arg0, arg1, arg2) {
